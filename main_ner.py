...
br = BuildRules(stop_w_list, './corpus/_clean_corpus/' + cat_corpus + '_' + size + '.txt', 3, db, '/home/alexandre/treetagger/cmd/')

# # extract seeds
# br.extract_rules(["filme"], "O")
# br.extract_rules(["filme", "longa metragem", "blockbuster"], "O")
...
# todo lançar somente si corpus tagged não existe
# br.build_corpus_tag()

br.extract_potential_nes__2()
pot_ne_not_treated = [n.surface for n in br.get_children_items(0)]
