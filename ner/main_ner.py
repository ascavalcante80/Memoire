...
#
# br.extract_seed_rules(["Minha Mãe é uma Peça 2","Assassin's Creed","xXx: Reativado","Eu Fico Loko","Moana - Um Mar de Aventuras","Passageiros","La La Land - Cantando Estações","Sing - Quem Canta Seus Males Espanta","Os Penetras 2 - Quem Dá Mais?","Sete Minutos Depois da Meia-Noite","Dominação","A Criada","Capitão Fantástico","Eu, Daniel Blake","Manchester à Beira-Mar","Rogue One - Uma História Star Wars","Elle","O Apartamento","Sully - O Herói do Rio Hudson","Animais Noturnos","Resident Evil 6: O Capítulo Final","A Bailarina","Quatro Vidas de um Cachorro",
#                        "Beleza Oculta","Max Steel","Até o Último Homem","Os Saltimbancos Trapalhões - Rumo a Hollywood","Axé: Canto Do Povo De Um Lugar"])

br.extract_seed_rules(["O bebê de Bridget Jones"])
# br.extract_seed_rules(["Neymar", "Cristiano Ronaldo", "Messy", "Gabriel Jesus", "Suárez", "Iniesta", "Piqué", "Ibrahimovic", ])
